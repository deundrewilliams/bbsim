...
class Week(models.Model):
    ...
    hoh = models.ForeignKey(
        "Houseguest", on_delete=models.CASCADE, related_name="week_hoh"
    )
    initial_nominees = models.ManyToManyField(
        "Houseguest", related_name="week_init_noms"
    )
    pov = models.ForeignKey(
        "Houseguest", on_delete=models.CASCADE, related_name="week_pov"
    )
    final_nominees = models.ManyToManyField(
        "Houseguest", related_name="week_final_noms"
    )
    evicted = models.ForeignKey(
        "Houseguest", on_delete=models.CASCADE, related_name="week_evicted"
    )
